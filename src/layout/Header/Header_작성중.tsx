...
import CommonHeaderRight from '../../pages/_layout/_headers/CommonHeaderRight';
...
const Header: FC<IHeaderProps> = ({ children, hasLeftMobileMenu, hasRightMobileMenu }) => {
	...
	// 	};
	// });
	// console.log("src\\layout\\Header\\Header.tsx > children")
					...
					<div className='row'>
						...
						{hasRightMobileMenu && (
							...
							<div>								
								...
								/>
								{!rightMenuStatus && (<strong>&nbsp;&nbsp;클릭시 메뉴가 열립니다.</strong>)}
							</div>
						)}
					</div>
				</div>
			</header>
			{/* dark | 전체화면 | 언어 | Panel | 프로필 아이콘 */}
			<header
				ref={refHeader}
