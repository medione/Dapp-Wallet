...
export const carniaPagesMenu = {
	carniaSettings: {
		id: 'carniaSettings',
		text: 'Carnia Settings',
		path: 'settings',
		icon: 'Dashboard',
		subMenu: null,
	},		
	...
	carniaWalletFuncCoinSelS: {
		id: 'carniaWalletFuncCoinSelS',
		text: 'Carnia Wallet Fuction Coin Select Send',
		path: 'funccoinsels',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaWalletFuncCoinSelR: {
		id: 'carniaWalletFuncCoinSelR',
		text: 'Carnia Wallet Fuction Coin Select Receive',
		path: 'funccoinselr',
		icon: 'Dashboard',
		subMenu: null,
	},	
	carniaWalletFuncCoinDetS: {
		id: 'carniaWalletFuncCoinDetS',
		text: 'Carnia Wallet Fuction Coin Detail Send',
		path: 'funccoindets',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaWalletFuncCoinDetR: {
		id: 'carniaWalletFuncCoinDetR',
		text: 'Carnia Wallet Fuction Coin Detail Receive',
		path: 'funccoindetr',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaWalletSwap: {
		id: 'carniaWalletSwap',
		text: 'Carnia Wallet Swap',
		path: 'swap',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaWalletSwapC: {
		id: 'carniaWalletSwapC',
		text: 'Carnia Wallet Swap Cross',
		path: 'swapc',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaWalletCoinsDet: {
		id: 'arniaWalletCoinsDet',
		text: 'Carnia Wallet Coins Detail',
		path: 'coinsdet',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaWalletCoinsDetSRtn: {
		id: 'carniaWalletCoinsDetSRtn',
		text: 'Carnia Wallet Coins Detail Send Return',
		path: 'funccoinsdetsrtn',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaWalletCoinsDetRRtn: {
		id: 'carniaWalletCoinsDetRRtn',
		text: 'Carnia Wallet Coins Detail Receive Return',
		path: 'funccoindetrrtn',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaWalletCoinsDetQrySel: {
		id: 'carniaWalletCoinsDetQrySel',
		text: 'Carnia Wallet Coins Detail Query Select',
		path: 'coinsdetqrysel',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaWalletStakingDet: {
		id: 'carniaWalletStakingDet',
		text: 'Carnia Wallet Staking Detail',
		path: 'stakingdet',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaWalletStakingExchgSnd: {
		id: 'carniaWalletStakingExchgSnd',
		text: 'Carnia Wallet Staking Exchange Send',
		path: 'stakingexchgsnd',
		icon: 'Dashboard',
		subMenu: null,
	},	
	carniaWalletStakingExchgRcv: {
		id: 'carniaWalletStakingExchgRcv',
		text: 'Carnia Wallet Staking Exchange Receive',
		path: 'stakingexchgrcv',
		icon: 'Dashboard',
		subMenu: null,
	},			
	carniaWalletStakingDetQrySel: {
		id: 'carniaWalletStakingDetQrySel',
		text: 'Carnia Wallet Staking Detail Query Select',
		path: 'stakingdetqrysel',
		icon: 'Dashboard',
		subMenu: null,
	},	
	carniaCoinRaise: {
		id: 'carniaCoinRaise',
		text: 'Carnia CoinRaise',
		path: 'coinraise',
		icon: 'Dashboard',
		subMenu: null,
	},	
	carniaSubTopCoin: {
		id: 'carniaSubTopCoin',
		text: 'Carnia SubTop Coin',
		path: 'subTopCoin',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaCoinRaiseDet: {
		id: 'carniaCoinRaiseDet',
		text: 'Carnia Coin Raise Detail',
		path: 'coinraisedet',
		icon: 'Dashboard',
		subMenu: null,
	},
	carniaSubTopCoinSwap: {
		id: 'carniaSubTopCoinSwap',
		text: 'Carnia SubTop Coin Swap',
		path: 'subTopCoinSwap',
		icon: 'Dashboard',
		subMenu: null,
	},			
	carniaCoinSwapRaiseDet: {
		id: 'carniaCoinSwapRaiseDet',
		text: 'Carnia Coin Swap Raise Detail',
		path: 'coinswapraisedet',
		icon: 'Dashboard',
		subMenu: null,
	},	
};
