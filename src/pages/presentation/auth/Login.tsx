...
const LoginHeader: FC<ILoginHeaderProps> = ({ isNewUser }) => {
	if (isNewUser) {
		console.log("Login.tsx > isNewUser")
		console.log(isNewUser)
		return (
			<>
				<div className='text-center h1 fw-bold mt-5'>계정 생성</div>
				<div className='text-center h4 text-muted mb-5'>시작하려면 가입한후 계정 생성!</div>
			</>
		);
	}
	return (
		<>
			...
			<div className='text-center h4 text-muted mb-5'>계속하시려면 등록 되어야 합니다!</div>
		</>
	);
};
	...
	const formik = useFormik({
		...
		validate: (values) => {
			...
			if (!values.loginUsername) {
				errors.loginUsername = '필수항목';
			}

			if (!values.loginPassword) {
				errors.loginPassword = '필수항목';
			}
								...
								<Alert isLight icon='Lock' isDismissible>
									<div className='row'>
										<div className='col-12'>
											<strong>성명:</strong> {USERS.JOHN.username}
										</div>
										<div className='col-12'>
											<strong>비밀번호:</strong> {USERS.JOHN.password}
										</div>
									</div>
								</Alert>
