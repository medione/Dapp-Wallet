...
const CoinDataItem: FC<ICoinDataItemProps> = ({ id, image, name, type, price, count, date }) => {
...
const CarniaCoinSwapRaise = () => {
	const [ isRcvCoin, setRcvCoin ]  = useState<boolean>(true);	
	const [ isSndCoin, setSndCoin ]  = useState<boolean>(false);	
									...
									<div className='me-5'>
										<ButtonGroup>
											<Button
												...
												// isLight
												tag='a'
												onClick={() => setPrintButton('rcvcoin')}
											>
												받은 코인
											</Button>
											<Button
												...
												tag='a'
												onClick={() => setPrintButton('sndcoin')}
												className='me-3'
											>
												보낸 코인
											</Button>
