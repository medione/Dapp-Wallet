...
const CarniaWallet = () => {
	...
	return (
		<PageWrapper title={'CarniaWallet'}>
			{/* <Page container='fluid' className='bg-warning'> */}
				{/* <Card className='bg-light'> */}
					<div className='d-flex justify-content-center'>
						<CardActions>
							<div 
								className='dflex-justify-content-center p-1 border border-primary border-1 rounded-3'>
				 ...
				 {/* <CardBody className='table-responsive'> */}
					{/* <CardActions className='table-responsive'> */}
