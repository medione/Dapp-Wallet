...
import CarniaCoinRaiseDetChart from './CarniaCoinRaiseDetChart';
...
const CarniaCoinRaiseDet = () => {
	...
	console.log('CarniaCoinRaiseDet > data')
	console.log(data)

	return (
		// <PageWrapper title={demoPagesMenu.appointment.subMenu.dashboard.text}>
		<PageWrapper title={'CarniaCoinRaiseDet'}>		
			{/* <div className='row' 
			...
			{/* <div className='d-flex justify-content-between align-items-center'>
				...
				<div className='h4'>MileVerse</div>
				<div/>
			</div> */}
			<Page container='fluid'>
				<div className='row'>
					<div className='col-12 col-xxl-6'>
								<CarniaCoinRaiseDetChart />
					</div>
...
export default CarniaCoinRaiseDet;
