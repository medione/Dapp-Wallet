...
const CarniaWalletFuncCoinDetRRtn = () => {
  return (
		<PageWrapper title='CarniaWalletFuncCoinDetRRtn'>
			<Card>
				<CardActions 
					// className='d-flex h2 justify-content-between'
				>
					{/* <div>
						<Button
							color='primary'
				...
				<div className='d-flex justify-content-center h4 mt-3 me-3'>
						Bitcoin 수신 주소
					</div>		
				{/* <CardHeader>
				</CardHeader> */}
				<CardBody className='d-flex justify-content-center ms-5'>
					<div>
						<div>
...
export default CarniaWalletFuncCoinDetRRtn;