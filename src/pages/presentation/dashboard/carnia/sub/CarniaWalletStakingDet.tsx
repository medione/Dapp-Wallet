...
import CarniaWalletStakingExchg from './../sub/CarniaWalletStakingExchg';
import CarniaWalletStakingDetQry from './../sub/CarniaWalletStakingDetQry';
...
const CarniaWalletStakingDet  = () => {
	...
	return (
		<PageWrapper title={'CarniaWalletStakingDet'}>
			<Page container='fluid'>
				...
				<div className='col-12'>
							<CarniaWalletStakingExchg />
				</div>
				<div className='col-12'>
							<CarniaWalletStakingDetQry />
				</div>
			</Page>
		</PageWrapper>
	);
...
export default CarniaWalletStakingDet ;
