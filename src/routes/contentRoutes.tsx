...
const CARNIA = {
	CARNIA_SETTINGS: lazy(() => import('../pages/presentation/dashboard/carnia/CarniaSettings')),		
	CARNIA_PROFILE: lazy(() => import('../pages/presentation/dashboard/carnia/CarniaProfile')),	
	CARNIA_COINRAISE: lazy(() => import('../pages/presentation/dashboard/carnia/CarniaCoinRaise')),
	CARNIA_SUBTOPCOIN: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaSubTopCoin')),
	CARNIA_SUBTOPCOINSWAP: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaSubTopCoinSwap')),	
	CARNIA_COIN_RAISEDET: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaCoinRaiseDet')),	
	CARNIA_COINSWAP_RAISEDET: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaCoinSwapRaiseDet')),	
	CARNIA_WALLET: lazy(() => import('../pages/presentation/dashboard/carnia/CarniaWallet')),	
	CARNIA_WALLET_FUNC_COINSELS: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletFuncCoinSelS')),	
	CARNIA_WALLET_FUNC_COINSELR: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletFuncCoinSelR')),
	CARNIA_WALLET_FUNC_COINDETS: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletFuncCoinDetS')),		
	CARNIA_WALLET_FUNC_COINDETR: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletFuncCoinDetR')),		
	CARNIA_WALLET_FUNC_COINSDETSRTN: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletFuncCoinDetSRtn')),	
	CARNIA_WALLET_FUNC_COINSDETRRTN: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletFuncCoinDetRRtn')),	
	CARNIA_WALLET_SWAP: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletSwap')),	
	CARNIA_WALLET_SWAPC: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletSwapC')),	
	CARNIA_WALLET_COINSDET: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletCoinsDet')),	
	CARNIA_WALLET_COINSDET_QRYSEL: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletCoinsDetQrySel')),	
	CARNIA_WALLET_STAKING_DET: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletStakingDet')),		
	CARNIA_WALLET_STAKING_EXCHANGE_SND: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletStakingExchgSnd')),		
	CARNIA_WALLET_STAKING_EXCHANGE_RCV: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletStakingExchgRcv')),			
	CARNIA_WALLET_STAKING_DETQRY_SEL: lazy(() => import('../pages/presentation/dashboard/carnia/sub/CarniaWalletStakingDetQrySel')),			
};
...
const presentation: RouteProps[] = [
	 ...
	 */
		{
			path: carniaPagesMenu.carniaSettings.path,
			element: <CARNIA.CARNIA_SETTINGS />,
		},			
		{
			path: carniaPagesMenu.carniaProfile.path,
			element: <CARNIA.CARNIA_PROFILE />,
		},		
		{
			path: carniaPagesMenu.carniaWallet.path,
			element: <CARNIA.CARNIA_WALLET />,
		},		
		{
			path: carniaPagesMenu.carniaWalletFuncCoinSelS.path,
			element: <CARNIA.CARNIA_WALLET_FUNC_COINSELS />,
		},		
		{
			path: carniaPagesMenu.carniaWalletFuncCoinSelR.path,
			element: <CARNIA.CARNIA_WALLET_FUNC_COINSELR />,
		},
		{
			path: carniaPagesMenu.carniaWalletFuncCoinDetS.path,
			element: <CARNIA.CARNIA_WALLET_FUNC_COINDETS />,
		},		
		{
			path: carniaPagesMenu.carniaWalletFuncCoinDetR.path,
			element: <CARNIA.CARNIA_WALLET_FUNC_COINDETR />,
		},	
		{
			path: carniaPagesMenu.carniaWalletSwap.path,
			element: <CARNIA.CARNIA_WALLET_SWAP />,
		},					
		{
			path: carniaPagesMenu.carniaWalletSwapC.path,
			element: <CARNIA.CARNIA_WALLET_SWAPC />,
		},
		{
			path: carniaPagesMenu.carniaWalletCoinsDet.path,
			element: <CARNIA.CARNIA_WALLET_COINSDET />,
		},
		{
			path: carniaPagesMenu.carniaWalletCoinsDetQrySel.path,
			element: <CARNIA.CARNIA_WALLET_COINSDET_QRYSEL />,
		},		
		{
			path: carniaPagesMenu.carniaWalletCoinsDetSRtn.path,
			element: <CARNIA.CARNIA_WALLET_FUNC_COINSDETSRTN />,
		},	
		{
			path: carniaPagesMenu.carniaWalletCoinsDetRRtn.path,
			element: <CARNIA.CARNIA_WALLET_FUNC_COINSDETRRTN />,
		},	
		{
			path: carniaPagesMenu.carniaWalletStakingDet.path,
			element: <CARNIA.CARNIA_WALLET_STAKING_DET />,
		},	
		{
			path: carniaPagesMenu.carniaWalletStakingExchgSnd.path,
			element: <CARNIA.CARNIA_WALLET_STAKING_EXCHANGE_SND />,
		},			
		{
			path: carniaPagesMenu.carniaWalletStakingExchgRcv.path,
			element: <CARNIA.CARNIA_WALLET_STAKING_EXCHANGE_RCV />,
		},					
		{
			path: carniaPagesMenu.carniaWalletStakingDetQrySel.path,
			element: <CARNIA.CARNIA_WALLET_STAKING_DETQRY_SEL />,
		},					
		{
			path: carniaPagesMenu.carniaCoinRaiseDet.path,
			element: <CARNIA.CARNIA_COIN_RAISEDET />,
		},				
		{
			path: carniaPagesMenu.carniaCoinRaise.path,
			element: <CARNIA.CARNIA_COINRAISE />,
		},		
		{
			path: carniaPagesMenu.carniaSubTopCoin.path,
			element: <CARNIA.CARNIA_SUBTOPCOIN />,
		},
		{
			path: carniaPagesMenu.carniaSubTopCoinSwap.path,
			element: <CARNIA.CARNIA_SUBTOPCOINSWAP />,
		},
		{
			path: carniaPagesMenu.carniaCoinSwapRaiseDet.path,
			element: <CARNIA.CARNIA_COINSWAP_RAISEDET />,
		},				
